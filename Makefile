...
run: build-web
	MAILTAIL_DATA_DIR=$(DATA_DIR) MAILTAIL_HTTP_ADDR=$(HTTP_ADDR) MAILTAIL_SMTP_ADDR=$(SMTP_ADDR) MAILTAIL_ACCEPTED_RCPT_DOMAINS="$(MAILTAIL_ACCEPTED_RCPT_DOMAINS)" MAILTAIL_ACCEPTED_FROM_DOMAINS="$(MAILTAIL_ACCEPTED_FROM_DOMAINS)" ./$(APP)
