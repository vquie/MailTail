...
run: build-web
	...
	MAILTAIL_AUTH_USERNAME="$(MAILTAIL_AUTH_USERNAME)" \
	MAILTAIL_AUTH_PASSWORD="$(MAILTAIL_AUTH_PASSWORD)" \
...
docker-run: docker-build
	...
	docker run \
		...
		$(DOCKER_ENV_FILE) \
		-e MAILTAIL_AUTH_USERNAME="$(MAILTAIL_AUTH_USERNAME)" \
		-e MAILTAIL_AUTH_PASSWORD="$(MAILTAIL_AUTH_PASSWORD)" \
